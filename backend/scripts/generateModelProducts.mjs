...
const modelInfo = {
  ...
  "free_low_poly_ruby__diamond_gold_necklace.glb": {
  ...
  "free_sunglasses_3d_model_by_arham_abdullah.glb": {
  ...
  "giant_red_oval_hoops_earings.glb": {
  ...
  "huggie_earrings_with_carat_of_diamonds.glb": {
  ...
  "romantic_floral_clay_locket.glb": {
  ...
  "sunglasses_mechanics_of_the_object_homework.glb": {
  ...
  "sunglasses_model_no1_cravatta.glb": {
  ...
  "turkish_earring_exclusive_for_the_first_time_no2.glb": {
  ...
  "turkish_earring_exclusive_for_the_first_time_no3.glb": {
